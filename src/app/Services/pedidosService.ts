...
export class PedidosService {
  ...
  getById(id:number){
    return this.http.get<PedidoFull>(`${this.apiUrl}/ObtenerPedido/${id}`);
  }
  ...
  modificarPedido(id:number , pedido:pediDTO){
  ...
  return this.http.get<pedidos[]>(`${this.apiUrl}/PedidosTerminados`);
  }
}
